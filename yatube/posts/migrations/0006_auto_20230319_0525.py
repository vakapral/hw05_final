# Generated by Django 2.2.6 on 2023-03-19 05:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(help_text='Ссылка группы', unique=True, verbose_name='Ссылка группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(help_text='Содержимое поста', verbose_name='Содержимое поста'),
        ),
    ]
